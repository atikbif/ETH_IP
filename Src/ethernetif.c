...
/* Init ETH */
  ...
  heth.Init.DuplexMode = ETH_MODE_FULLDUPLEX;//ETH_MODE_FULLDUPLEX;//ETH_MODE_HALFDUPLEX;
  heth.Init.PhyAddress = 1;//PHY_USER_NAME_PHY_ADDRESS;
  MACAddr[0] = 0x00;
  MACAddr[1] = 0x80;
  MACAddr[2] = 0xE1;
  MACAddr[3] = 0xA0;
